...
- the variances of $y-1$ and $y_2$ are equal,
...
- The groups do not systematically differ on $y_1$ (given random assignment. Of course, in any sample within the simulation the there will be non-systematic differences across groups do to sampling error).
...
- $y_1$ and $y_2$ have equal variances (set to 10; if these variances were not equal, the  power advantage will increase for ANCOVA).  We will set the mean for $y$, without intervention to 20.  This has not effect on power. 
